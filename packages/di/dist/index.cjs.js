...
let Container = (() => {
    ...
    return _a = class Container {
        ...
        (() => {
            ...
            _id_decorators = [mobx.observable];
            _stores_decorators = [mobx.observable];
            _props_decorators = [mobx.observable];
            _registerStores_decorators = [mobx.action];
...
let Root = (() => {
    ...
    return _a = class Root {
        ...
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _containers_decorators = [mobx.observable];
            _globalContainer_decorators = [mobx.observable];
            _createContainer_decorators = [mobx.action];
...
const ContainerContext = React.createContext(Symbol());
...
function useInjection(store) {
    const id = React.useContext(ContainerContext);
...
let ProductsStore = (() => {
    ...
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _name_decorators = [mobx.observable];
        _setName_decorators = [mobx.action];
...
let UsersStore = (() => {
    ...
    (() => {
        ...
        _productsStore2_decorators = [inject(exports.Stores.MY_CUSTOM_PRODUCTS_STORE)];
...
const App = mobxReactLite.observer(() => {
    ...
    const productsStore2 = useInjection(exports.Stores.MY_CUSTOM_PRODUCTS_STORE);
...
const Profile = mobxReactLite.observer(() => {
...
exports.createInjectableComponent = createInjectableComponent;
exports.inject = inject;
exports.injectGlobal = injectGlobal;
exports.injectable = injectable;
exports.root = root;
exports.useGlobalInjection = useGlobalInjection;
